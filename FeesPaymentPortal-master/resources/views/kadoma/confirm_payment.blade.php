                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        ...
                                        <strong>Client Name :</strong> {{ $payment->student_name }} <br>
                                        <strong>Client Number  :</strong> {{ $payment->reg_number }}<br>
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    ...
                                    <form method="post" action="/golden_payment/submit_payment/{{$payment->id}}">
                                        @csrf
