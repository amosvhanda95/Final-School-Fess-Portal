...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kadoma Council Capture  Payment</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-cyan">
                        ...
                        <form method="post" action="/payment/kadoma-make_payment" id="quickForm">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php $firstResponse = $arrayResponse[0]; ?>

                                                <div class="form-group">
                                                    <label for="message">ID Number</label>
                                                    <input type="text" readonly placeholder="Message"
                                                           name="message" class="form-control"
                                                           value={{ $firstResponse['ID'] ?? '' }}>
                                                </div>
                                                <div class="form-group">
                                                    <label for="student_name">Client Full Name</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="policy_name">Balance </label>
                                                    <input type="text" readonly placeholder="Enter Policy Name"
                                                           name="semester" class="form-control"
                                                           value="{{ $firstResponse['bal'] ?? '' }}"
                                                           style="color: {{ isset($firstResponse['bal']) && $firstResponse['bal'] < 0 ? 'green' : 'red' }};">
                                                </div>
                                                
                                                
                                                <div class="form-group">
                                                    <label for="policy_number">Account Number</label>
                                                    <input type="text" readonly placeholder="Enter Policy Number"
                                                           name="reg_number" class="form-control"
                                                           value={{ $firstResponse['account'] ?? '' }}>
                                                </div>
