                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Please Enter the Bank Account Number & House Account Numberfor Kadoma City Council </h3>
                        </div>
                        ...
                        @endif
                        <form method="post" action="/payment/kadoma_id_account_search">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label required">{{ __('Council Account Number') }}</label>
                                    <input name="council_account_number" class="form-control" id="council_account_number" value = "11540">
