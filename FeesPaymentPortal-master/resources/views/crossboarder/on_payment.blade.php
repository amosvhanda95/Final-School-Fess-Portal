      ...
      <div class="row">
         <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
               ...
               <div class="col-12">
                        <form method="post" action="/payment/confirm_submit_payment">
                            @csrf
                            <input type="hidden" name="total_principal_amount" value="{{ number_format($amount * 0.06, 2) }}">
                            ...
                            <button type="submit" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Confirm Payment</button>
                            <a href="/crossboarder" class="btn btn-danger float-right" style="margin-right: 10px;">
                                <i class="far fa-credit-card"></i> Cancel Payment
                            </a>
